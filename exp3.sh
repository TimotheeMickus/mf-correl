...
for EMB_ARCH in randlstm randtf; do
  echo ${EMB_ARCH};
  python3 src/exp3_test_sick.py --emb_arch ${EMB_ARCH} --emb_path ${EMB_ARCH}.pkl --sick_path ${SICK_PATH} --output_file "data/results_exp3/sick/${EMB_ARCH}-results-sick.txt";
done;
